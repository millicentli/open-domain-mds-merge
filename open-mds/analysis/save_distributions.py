...
Example command:
python ./scripts/uncertainty_index_and_retrieve.py "ms2" "./output/datasets/ms2_full" 2 10
"""
...
def main(
    ...
    for split in splits:
        ...
        # Save the scores so we can plot the distribution
        retrieved.to_csv(os.path.join("/home/li.mil/open-domain-mds-merge/open-mds/analysis/csv", split + "_probs.csv"))
