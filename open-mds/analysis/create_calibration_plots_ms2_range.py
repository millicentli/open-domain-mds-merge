...
pt_dataset = indexing_basic.MSLR2022Dataset(name="ms2")
...
indexer = SentenceTransformersIndexer(
    model_name_or_path="/scratch/li.mil/open-domain-mds-merge/contriever_msmarco_ms2/model_best",
...
pickle.dump(logreg, open("/scratch/li.mil/open-domain-mds-merge/platt_calibration/ms2/logreg_100.pkl", "wb"))
...
pickle.dump(logreg_200, open("/scratch/li.mil/open-domain-mds-merge/platt_calibration/ms2/logreg_200.pkl", "wb"))
...
pickle.dump(logreg_500, open("/scratch/li.mil/open-domain-mds-merge/platt_calibration/ms2/logreg_500.pkl", "wb"))
...
pickle.dump(logreg_1000, open("/scratch/li.mil/open-domain-mds-merge/platt_calibration/ms2/logreg_1000.pkl", "wb"))
...
ax_calibration_curve.set_title("Calibration plots (Logistic Regression, top-k)")
...
fig.tight_layout()
plt.savefig('/home/li.mil/open-domain-mds-merge/open-mds/analysis/calibration_plot_ms2_range.png', bbox_inches='tight')
